...
const sectionsProp = [
  ...
  describe(`Accordian Component`, () => {
    test("renders empty given no Accordian without errors", () => {
      const wrapper = shallow(<Accordian />);
      expect(toJson(wrapper)).toMatchSnapshot();
    });
  
    test("renders the no sections by default", () => {
      const wrapper = shallow(<Accordian sections={sectionsProp} />);
      expect(toJson(wrapper)).toMatchSnapshot();
    });
  
    test("opens any clicked section", () => {
      const wrapper = shallow(<Accordian sections={sectionsProp} />);
      wrapper
        .find("button")
        .at(1)
    ...
    test("only opens one section at a time", () => {
      const wrapper = shallow(<Accordian sections={sectionsProp} />);
      wrapper
        .find("button")
        .at(1)
